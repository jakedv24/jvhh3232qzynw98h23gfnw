...
<html lang="en-US">
	...
	<body>
		...
		<div class="background" style="opacity:.4;">
			...
			<div class="textbox">
				<div style="width:100%;height:17px;background:transparent;"></div>
				<div style="min-height:92%;width:95%;color:grey;background-color:#D0D0D0;position:relative;margin:auto;padding-top:15px;opacity:2;">
				</div>
	...
	<footer style="background:grey;min-height:200px;width:100%;border-radius:0px;border-color:black;border-width:3px;">
	</footer>
</html>
